...
class TagInfo extends Command {
    ...
    async run(interaction) {
        ...
        const tag = await interaction.client.database.tags.get(`${tagname.toLowerCase()}_${interaction.guild.id}`);
        const tagAuthor = await interaction.client.resolveUser(tag.author);
